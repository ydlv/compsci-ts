...
export class DirectedHamiltonToUndirected<V, E extends Edge<V> = Edge<V>> 
extends AbstractReduction<Graph<V, E>, readonly V[], Graph<[V, N]>, readonly [V, N][]>  {
    ...
    convertInput(g: Graph<V, E>): Graph<[V, N], { readonly from: [V, N]; readonly to: [V, N]; }> {
        ...
        const g2: EdgeMutableGraph<[V, N]> = new MatrixGraph(reducedNode, {nodeEqualityType: "structural"});
