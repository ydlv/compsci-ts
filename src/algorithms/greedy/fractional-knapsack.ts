...
export function fractionalKnapsack({ artifacts, capacity }: FractionalKnapsakProblem): FractionalKnapsakProblemSolution {
    const sorted = query(artifacts).sortBy(a => a.price / a.weight, "descending").toArray();
